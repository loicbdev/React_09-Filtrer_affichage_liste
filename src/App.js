...
class App extends Component {
  ...
  showOnlySimpsonsOnClick = () => {
    this.setState({ showOnlySimpsons: !this.state.showOnlySimpsons });
  };

  render() {
    return (
      <div>
        <button onClick={this.showOnlySimpsonsOnClick}>
          {this.state.showOnlySimpsons ? 'All quotes' : 'Only Simpsons quotes'}
        </button>
        {this.state.quoteList
          .filter(
            (quote) =>
              !this.state.showOnlySimpsons ||
